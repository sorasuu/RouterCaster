            ...
            case .success(response: let response):
                ...
                URLSession.shared.dataTask(with: url) { (data, response, err) in
                    ...
                    let documentData = [SparkKeys.SparkUser.uid: uid,
                                        ...
                                        SparkKeys.SparkUser.profileImageUrl: profileImageFacebookUrl,
                                        SparkKeys.SparkUser.accountType : "fb"
                        /* remember to change this to the Firebase Storage url later on*/] as [String : Any]
        ...
        Storage_Profile_Images.child(fileName).putData(profileImageUploadData, metadata: nil) { (metadata, err) in
            ...
            Spark.getDownloadUrl(from: path, completion: { (profileImageFirebaseUrl, err) in
                ...
                let documentData = [SparkKeys.SparkUser.uid: sparkUser.uid,
                                    ...
                                    SparkKeys.SparkUser.profileImageUrl: profileImageFirebaseUrl,
                                    SparkKeys.SparkUser.accountType: "fb"] as [String : Any]
